...
public class ScreenshotUtility implements ITestListener{	
	...
	public void onStart(ITestContext tr) {	
		Globals.GC_MANUAL_TC_NAME = tr.getName();
		System.out.println("ScreenshotUtility.onStart TC = " + tr.getName());
	...
	public void onTestStart(ITestResult tr) {
		System.out.println("Teststarted running:"  + tr.getMethod().getMethodName() + " at:" + tr.getStartMillis());
	}
	...
	public void captureScreenShot(ITestResult result, String status){	
		String destDir = "";
		System.out.println("Screenshot method" + status);
