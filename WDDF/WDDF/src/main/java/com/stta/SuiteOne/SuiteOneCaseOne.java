...
public class SuiteOneCaseOne extends SuiteOneBase{
	...
	public void checkCaseToRun() throws IOException{
		System.out.println(" SuiteOneCaseOne.checkCaseToRun @BeforeTest");
	...
	//This data provider method will return 4 column's data one by one In every Iteration.
		...
		public Object[][] SuiteOneCaseOneData(){
			System.out.println(" SuiteOneCaseOne.SuiteOneCaseOneData @DataProvider");
	...
	public void SuiteOneCaseOneTest(String DataCol1,String DataCol2,String DataCol3,String ExpectedResult) throws Exception{
		System.out.println(" SuiteOneCaseOne.SuiteOneCaseOneTest @Test");
		DataSet++;
		System.out.println("---executing SuiteOneCaseOneTest ---");
		...
		System.out.println("Initiating the test End");
		...
		Reporter.logEvent(Status.INFO, "txt_Result", "txt_Result cleared", false);
		...
		Reporter.logEvent(Status.INFO, "txt_Result", "Result = "+Result, false);
		//To Convert data from String to Integer
		...
		System.out.println("1-1 2" + Testfail+ActualResultInt + " == " + ExpectedResultInt);
		if(Testfail){
			Reporter.logEvent(Status.FAIL, "step sample", "teting report detail", true);
			...
			Reporter.logEvent(Status.PASS, "step sample", "teting report detail", true);
		}
	}
	...
	public void reporterDataResults(){	
		System.out.println(" SuiteOneCaseOne.reporterDataResults @AfterMethod");
		if(Testskip){
