...
public class SuiteOneCaseTwo extends SuiteOneBase{
	...
	public void checkCaseToRun() throws IOException{
		System.out.println(" SuiteOneCaseTwo.checkCaseToRun @BeforeTest");
	...
	public void SuiteOneCaseTwoTest(String DataCol1,String DataCol2,String DataCol3,String ExpectedResult) throws Exception{
		...
		System.out.println("1-2 get element start");
		getElementByName("txt_Result").clear();
		System.out.println("1-2 get element start 1");
		getElementByXPath("btn_Calc_PrePart",ValueOne,"btn_Calc_PostPart").click();
		System.out.println("1-2 get element start 2");
		getElementByID("btn_Minus").click();
		System.out.println("1-2 get element start 3");
		getElementByXPath("btn_Calc_PrePart",ValueTwo,"btn_Calc_PostPart").click();
		System.out.println("1-2 get element start 4");
		getElementByID("btn_Minus").click();
		System.out.println("1-2 get element start 5");
		getElementByXPath("btn_Calc_PrePart",ValueThree,"btn_Calc_PostPart").click();
		System.out.println("1-2 get element start 6");
		getElementByCSS("btn_Equals").click();
		System.out.println("1-2 get element start end");
		...
		System.out.println("1-2 2" + Testfail+ActualResultInt + " == " + ExpectedResultInt);
		if(Testfail){
